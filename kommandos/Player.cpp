...
#define PLAYER_MODEL "../media/Models/player/player.3ds"
...
void Player::Init()
{
	...
	if (playerObject)
	{
		...
		playerObject->setScale(vector3df(4, 4, 4));
		playerObject->setMaterialFlag(EMF_LIGHTING, true);
		//playerObject->setMaterialTexture(0, playerDriver->getTexture(GUN_MODEL));
	}
